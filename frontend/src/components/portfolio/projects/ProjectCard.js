      ...
      <div className="card shadow rounded-4 overflow-hidden mb-4">
        <div className="p-4 text-white position-relative" style={{ background: getProjectGradient(project.category) }} >
          ...
          <div className="d-flex justify-content-between align-items-center">
            ...
            <div><i class="fa-solid fa-layer-group"></i> <span className="fw-semibold" title={project.category ? project.category.join(', ') : 'Uncategorized'} >{formatCategories(project.category)}</span>
            </div>
          </div>
